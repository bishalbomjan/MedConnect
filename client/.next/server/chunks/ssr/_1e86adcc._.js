...
const registerSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["object"])().shape({
    email: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["string"])().email('Please enter a valid email address').required('Email is required'),
    role: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["string"])().oneOf([
        'patient',
        'doctor'
    ], 'Please select a valid role').required('Role is required'),
    phoneNumber: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["string"])().matches(/^[+]?[\d\s\-()]+$/, 'Please enter a valid phone number').min(10, 'Phone number must be at least 10 digits').required('Phone number is required'),
    location: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["string"])().min(3, 'Location must be at least 3 characters').required('Location is required'),
    password: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["string"])().min(8, 'Password must be at least 8 characters').matches(/(?=.*[a-z])/, 'Password must contain at least one lowercase letter').matches(/(?=.*[A-Z])/, 'Password must contain at least one uppercase letter').matches(/(?=.*\d)/, 'Password must contain at least one number').required('Password is required'),
    confirmPassword: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["string"])().oneOf([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ref"])('password')
...
const Register = ()=>{
    const handleSubmit = async (values, { setSubmitting })=>{
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"])({
