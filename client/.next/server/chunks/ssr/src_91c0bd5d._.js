        ...
        const mockData = Array.from({
            length: 50
                ...
                doctorId: {
                    ...
                    experienceYear: Math.floor(Math.random() * 20) + 5,
                    isKycApproved: Math.random() > 0.3
                }
            }));
        const page = parseInt(url.split('page=')[1]) || 1;
        const limit = parseInt(url.split('limit=')[1]?.split('&')[0]) || 5;
...
const Appointment = ()=>{
    ...
    const [totalPages, setTotalPages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(10); // Set to 10 for better demonstration
...
//# sourceMappingURL=src_91c0bd5d._.js.map