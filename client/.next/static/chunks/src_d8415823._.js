...
const PatientKyc = ()=>{
    ...
    const handleSubmit = async (values)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2d$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/patientKyc/${_id}`, values);
        if (response.data) {
