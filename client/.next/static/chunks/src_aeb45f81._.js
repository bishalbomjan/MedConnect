...
const PatientApproval = ()=>{
    ...
    const fetchPendingPatient = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2d$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/patientKyc?status=pending");
            setPatients(response.data);
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to fetch pending patients.");
            console.error(error);
        }
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PatientApproval.useEffect": ()=>{
            fetchPendingPatient();
        }
    }["PatientApproval.useEffect"], []);
    const handleApproval = async (patientId)=>{
        ...
        debugger;
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2d$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`/patientKyc/${patientId}`);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to approve patient.");
            console.error(error);
        }
    };
...
_s(PatientApproval, "2mHPNi2MF+s8ms7PrTd3nXwgmV8=");
_c = PatientApproval;
...
//# sourceMappingURL=src_aeb45f81._.js.map