...
const DoctorAppointments = () => {
  ...
  const [totalAppoint, setTotalAppoint] = useState<Number>();
  const pageLimit = 10;
  const [page, setPage] = useState(1);
  const fetchAppointments = async () => {
    const res = await apiClient.get(
      `/timeslot?doctorId=${_id}&page=${page}&limit=${pageLimit}`
    );
                    ...
                    >
                      <TableCell>
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="font-medium">
                            {a?.bookedById?.fullname || "Unbooked"}
                          </span>
                        </div>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">
                            {a?.bookedById?.patient?.phoneNumber || "-"}
                          </span>
                        </div>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-2">
                          <Button
                            ...
                            onClick={() => {
                              router.push(
                                `/users/doctor/prescription/${a._id}`
                              );
                            }}
                          >
                            Start Consulting
