...
const DoctorCreateSlot = () => {
  ...
  if (!doctor)
    return (
      <div>
        <p className="text-red-400 p-5 ">You haven't submitted the Kyc form</p>
        <Button
          className="bg-green-600 mx-4"
          onClick={() => router.push("/doctorKYC")}
        >
          Please fill Kyc Form
        </Button>
      </div>
    );

  if (doctor && doctor.isKycApproved === false)
    return (
      <p className="bg-green-100 py-5 px-2 text-xl text-gray-600">
        You haven't been approved yet.<br></br> Please Contact to Admin
      </p>
    );
      ...
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-green-600 text-lg">
            Add a new appointment time slot for your patients
          </p>
        </div>
        ...
        <Card className="mt-6 border-green-200 bg-green-50">
          <CardContent className="p-6">
            ...
            <ul className="text-green-700 space-y-2 text-sm">
              ...
              <li>
                • Time slots are automatically marked as available for booking
              </li>
              <li>
                • You can view and manage your slots in the Time Slots section
              </li>
            </ul>
          </CardContent>
        </Card>
